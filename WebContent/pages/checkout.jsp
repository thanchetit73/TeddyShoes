...
<body onload="onload()"> 
 ...
 if (cart == null) {
     ...
     session.setAttribute("cart", cart);
            ...
            if (users == null) {
                response.sendRedirect("/TeddyShoes2/CustomerLoginServlet");
            }
        %>
	...
	<div class="checkout-area ptb-100">
		<div class="container">
			<div class="col-md-7">
				...
				<!-- 	<form method="post" action="../bills?status=addbill" >  nếu giỏ hàng trống hiden = true
						<div class="row">
							<div class="col-md-12">
					 ...
					 <form action="/TeddyShoes2/CheckOutServlet" method="get">
                        <div>
                            <span>Address *</span>
				...
				<div class="your-order-payment">
					<div class="your-order">
						...
						<ul>
							...
							<li class="order-total">Tổng hóa đơn<span>
									$<%=cart.totalCart()%>
												đ</span></li>
						</ul>
					</div>
