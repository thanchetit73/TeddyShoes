...
<body>
				...
				<div class="row">
						...
						<div class="card">
							...
							<div class="card-body">
								<table id="bootstrap-data-table"
									...
									<tbody>
										<%
						ArrayList<Customer> listKhachHang = (ArrayList<Customer>) request.getAttribute("listKhachHang");
					...
					%>
										<tr>
											...
											<td><%=kh.getEmail()%></td>
											<td><%=kh.getShowName() %></td>
											<td><%=kh.getAvatar() %></td>
												<td>
										
											<button class="btn btn-primary"
													onclick="ThayDoiPhanQuyen(this)"
													data-id="<%=kh.getUserName() %>">admin</button></td>
													
											
											
											<td><button data-id="<%=kh.getUserName() %>" class="btn btn-secondary"
													onclick="Delete(this)">
	...
	function ThayDoiPhanQuyen(e){
		swal({
	  		  ...
	  		  if (result.value) {
	  			  ...
	  			  window.location.href = "CustomerGetListServlet?phanQuyen=admin&&userName=" + userName;
	  		  } else {
    ...
    function Delete(e) {
    	swal({
  		  ...
  		  if (result.value) {
  			  var tenKhachHang = e.getAttribute("data-id");
  			  window.location.href = "CustomerManageServlet?del=del&&tenKhachHang=" + tenKhachHang;
  		  } else {
  			  swal("Dữ liệu của bạn không thay đổi!");
  		  }
  		});
