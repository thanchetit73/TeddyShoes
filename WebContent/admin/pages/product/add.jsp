					...
					<div class="col-md-12">
						<div class="card">
							...
							<div class="card-body card-block">
								<form action="ProductsInsertServlet" method="get" enctype="multipart/form-data"
										...
										<div class="col-md-6">
											...
											<div class="form-group">
												<label class="form-control-label">Sản phẩm mới</label> <select
													name="newProduct" id="" class="form-control">
											...
											<div class="form-group">
												...
												<textarea rows="10" cols=""
													placeholder="Nội dung chi tiết sản phẩm" class="form-control"
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<select name="typeId" id="" class="form-control"
													required="required">
													<% for(Category s: lstC){ %>
													<option value="<%=s.getType_ID()%>"><%=s.getType_Name() %></option>											
													<%} %>													
												</select>
											</div>
											<div class="form-group">
												<label class="form-control-label">Khuyến mãi %(nếu có):</label> <input
													type="type" placeholder="Nhập khuyến mãi"
													class="form-control" name="promotionPrice" value="0">
											</div>
											<div class="form-group">
												<label class="form-control-label">Nhập hãng</label> <input
													type="text" placeholder="Nhập hãng"
													class="form-control" name="unit" value="0"
													>
											</div>
											<div class="form-group">
												<label class="form-control-label">Chọn ảnh</label>
												<div>
													<input type="file" name="image" id="profile-img"> <img
														src="" id="profile-img-tag" width="500px"
														style="display: block; margin-left: auto; margin-right: auto;" />
												</div>
											</div>
											<div class="form-actions form-group">
												<button type="submit" value="" name="them" class="btn btn-success">Thêm mới</button>
