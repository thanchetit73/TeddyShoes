		...
		<div class="content">
			<div class="animated fadeIn">
				<div class="row">
					...
					<div class="col-md-12">
					<form action="StatisticalQuantityServlet" method="get"
									...
									<div class="row">
										...
										<div class="col-md-2">
											<div class="form-actions form-group">
												<button type="submit" value="thongkesl" name="thongkesl"
							...
							<%	ArrayList<Statistical> listThongKeSL = (ArrayList<Statistical>) request.getAttribute("listThongKeSL");
							
							 if( listThongKeSL != null){
							 %>
							<div class="card">
						...
						for (Statistical tk : listThongKeSL) {
					%>
										<tr>
