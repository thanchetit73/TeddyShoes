					...
					<div class="col-md-12">
						<div class="card">
							...
							<div class="card-body card-block">
								<form action="StatisticalServlet" method="get"
									...
									<div class="row">
										...
										<div class="col-md-2">
											<div class="form-actions form-group">
												<button type="submit" value="thongke" name="thongke"
									...
									<div class="row">
											<div class="form-group">
												<label class="form-control-label">Doanh Thu Của Cửa Hang Là:</label> <input
													type="text" placeholder="<%=total %>" class="form-control"
													   readonly="readonly">
											</div>
											</div>
											<%} %>
