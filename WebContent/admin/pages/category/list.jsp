						...
						<div class="card">
							<div class="card-header">
								<strong class="card-title">Danh sách</strong> <a
									class="btn btn-primary float-right" href="CategoryInsertServlet"><span><i
							...
							<div class="card-body">
								<table id="bootstrap-data-table"
                                    ...
                                    %>
										<tr>
											<td><%=c.getType_ID() %></td>
											<td><%=c.getType_Name() %></td>
											
											<td><a class="btn btn-success"
												href="CategoryUpdateServlet?mtl=<%=c.getType_ID()%>&&ttl=<%=c.getType_Name()%>"><span><i
														class="fa fa-edit"></i></span> Sửa</a></td>
											<td><a class="btn btn-secondary" href="CategoryDelServlet?mtl=<%=c.getType_ID()%>">
<span><i class="fa fa-trash-o" ></i></span> Xóa</a></td>
										</tr>
										<%} %>
									</tbody>
								</table>
