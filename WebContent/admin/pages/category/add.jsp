					...
					<div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form action="CategoryInsertServlet" method="post" enctype="application/x-www-form-urlencoded" class="form-horizontal">
                                    <div class="row">
                                    	<div class="col-md-6">
                                    	<!-- <div class="form-group">
                                        <label class="form-control-label">Ma loai sản phẩm</label>
                                        <input type="text" placeholder="Nhập ma loại sản phẩm" class="form-control" name="ml" required="required">
                                    </div> -->
                                    <div class="form-group">
                                        <label class="form-control-label">Tên loại sản phẩm</label>
                                        <input type="text" placeholder="Nhập tên loại sản phẩm" class="form-control" name="tl" required="required">
                                    </div>
