...
<body>
	...
	<div id="right-panel" class="right-panel">
		...
		<div class="content">
		<% Customer kh = (Customer)request.getAttribute("admin"); %>
									...
									<div class="row">
										<div class="col-sm-3">
											...
											<div class="text-center">
												...
												%>
												<img
													src="../../../assets/img/testimonial/<%=kh.getAvatar() %>)%>"
										...
										<div class="col-sm-9">
											<div class="card border-dark mb-3">
												...
												<div class="card-body text-dark">
													<h5 class="card-title"><%=kh.getUserName() %></h5>
												</div>
											</div>
											...
											<div class="card border-dark mb-3">
												...
												<div class="card-body text-dark">
													<h5 class="card-title"><%=kh.getEmail() %></h5>
												</div>
											</div>
<div class="card border-dark mb-3">
												<div class="card-header font-weight-bold">Tên Hiển Thị</div>
												<div class="card-body text-dark">
													<h5 class="card-title"><%=kh.getShowName() %></h5>
												</div>
											</div>
											<div class="card border-dark mb-3">
														...
														<div class="col-sm-4">
															<div class="form-group">
																<button
																	...
																	onclick="ThayDoiMatKhau(<%=kh.getUserId()%>)">LƯU
																	THAY ĐỔI </button>
															</div>
														</div>
														<div class="col-sm-4"></div>
